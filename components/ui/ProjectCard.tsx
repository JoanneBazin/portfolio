...
export const ProjectCard = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative bg-background w-full sm:w-5/6 lg:w-2/3 p-3 sm:p-6 rounded-xl cursor-pointer border border-transparent transition-all duration-250 z-20 ${
